...
klik wa.me/${conn.user.jid.split`@`[0]}`, m.chat, {
      ...
      if (!room.pilih) this.sendMessage(room.p, 'Silahkan ketik (Batu, Gunting, Kertas)', m)
      if (!room.pilih2) this.sendMessagw(room.p2, 'Silahkan ketik (Batu, Gunting, Kertas)', m)
