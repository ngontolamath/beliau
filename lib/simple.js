...
exports.smsg = (conn, m, hasParent) => {
     ...
     */
     m.reply = async (text, chatId, options) => {
        ...
        conn.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: conn.parseMention(text), externalAdReply: { title: 'Group', body: `Klik disini!`, sourceUrl: 'https://chat.whatsapp.com/I177s5gZAfe5oVqp9iVZIn', thumbnail: data }}, options })
    }
